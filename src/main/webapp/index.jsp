...
%>
	<table class="navbar">
		<tr>
			...
			<td style="border-bottom: 3px solid #189AD3"><a href="index.jsp">Home</a></td>
	...
	<div class="cover">
		<img src="img2.jpeg" alt="cover_img" width="100%">
		<button class="btn" onclick="location.href='signup.jsp'">As Investor</button>
				<button class="btn2" onclick="location.href='register.jsp'">As Startup</button>
	</div>
	...
	if(count>0)
	{
		for(i=0;i<count && i<4;i++) { %>
				<td>
					...
					<div class="cmpdet">
					<div class="prbar_cmp1"><div  style="width:<%= 100 - (cl.get(i).getStake())%>%;"></div>
					</div>
